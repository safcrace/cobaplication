...
<head>
  ...
  <title>{{ config('app.name', 'Quetzalito Ya!') }}</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-mini"><b>Q</b>YA</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Quetzalito</b>YA</span>
    </a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        CONTRATOS
        <small>Solcitudes Pendientes</small>
      </h1>
      <ol class="breadcrumb">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017 <a href="http://almsaeedstudio.com">Quetzalito Ya</a>.</strong> All rights
    reserved.
  </footer>
