              ...
              <div class="col-md-10 col-md-offset-1">
                 ...
                 <div class="panel panel-default">
                   <div class="panel-heading">
                      <h4 class="box-title">Datos Laborales: {{$individual->nombre1 . " " . $individual->nombre2 . " " . $individual->apellido1 . " " . $individual->apellido2}}</h4>
                    </div>
                   ...
                   <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                          <input type="text" class="form-control" name="" value="{{$individual->salario_mensual }}" disabled="true">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                          <input type="text" class="form-control" name="" value="{{$individual->telefonos_empresa }}" disabled="true">
                        </div>
                        <div class="col-md-2">
                          <label>Puesto</label>
                        </div>
                        <div class="col-md-3">
                          <input type="text" class="form-control" name="" value="{{$individual->puesto }}" disabled="true">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                          <input type="text" class="form-control" name="" value="{{$individual->jefe_inmediato }}" disabled="true">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                          <input type="text" class="form-control" name="" value="{{$individual->tipo_salario }}" disabled="true">
                        </div>
                        <div class="col-md-2">
                          <label>Celular Jefe</label>
                        </div>
                        <div class="col-md-3">
                          <input type="text" class="form-control" name="" value="{{$individual->celular_jefe }}" disabled="true">
                        </div>
